...
<template>
  <div style="display: flex;">
    <div style="border: 1px solid black;width: 300px">
      <form>
        ...
        <p style="background-color: azure"><label>同意协议(checkbox)：</label>
          <input type="checkbox" v-model="data.ack"/>
        </p>
    ...
    <div style="border: 1px solid blue;width: 200px">
      ...
      <p style="background-color: azure"><label>同意协议：{{ data.ack }}</label>
      </p>
      <p style="background-color: azure">
        <label>兴趣：</label>
        <span v-for="h in data.hobby">{{ h }}&nbsp;</span>
      </p>
      <p style="background-color: azure">
      ...
      <p style="background-color: azure">
        <label>课程：</label>
        <span v-for="c in data.course">{{ c }}&nbsp;</span>
      </p>
    </div>
  </div>
</template>
